...
/**
 * Class VwAcessoplaylist
 * @package App\Model\Entity
 * @table vw_acessoplaylist
 */
class VwAcessoplaylist extends BdAction
{

    /**
     * VwAcessoplaylist constructor.
     ...
     * @param int $nu_acesso
     */
    public function setNuAcesso($nu_acesso)
    {
